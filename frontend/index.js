...
import { initializeBlock, useGlobalConfig,FormField,Input } from '@airtable/blocks/ui';
...
const App = () => {
  ...
  const [accessToken, setAccessToken] = useState(globalConfig.get('accessToken') || '');
    ...
    const handleSendEmails = async () => {
        ...
        const emails = [
            { email: 'vimaldivas12@gmail.com', firstName: 'John', lastName: 'Doe' },
            // Add more email objects as needed
        ];
        const subject = 'Your Subject';
        const message = 'Hello {firstName} {lastName}, this is a personalized message.';
